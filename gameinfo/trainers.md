	...
	<div class='tab-content'>
		<div id='烏迪' class='tab-pane fade in active'>
			<div class='row'>
				...
				<div class='col-xs-12 col-md-3 text-center'>
					<img src='http://i.imgbox.com/rRIqki7A.jpg' class='trainer_img img-rounded'>
				</div>
				<div class='col-xs-12 col-md-5'>
					<div class="trainer_enable">
						<ul class='list-group'>
				...
				<div class='col-xs-12 col-md-4'>
					<table class="trainer_info">
						<tbody>
							<tr>
								<th style="width:4em;">屬性</th>
								<td>地</td>
							</tr>
							<tr>
								<th>體力</th>
			...
			<div class='row'>
				<div class='col-xs-12 col-md-12'>
					<table class="trainer_skills">
						<thead>
							<th style='width:2em;'>&nbsp;</th>
							<th style='width:6em;'>技能</th>
						...
						<tbody>
							...
							<td>펫 박사</td>
							<td>800</td>
							<td>1隻我方寵物屬性在 2回合內變換為水屬性<br><strong>【當對象主屬性為水屬性】</strong> 2回合內提高防禦力 34.75%</td>
							</tr>
		...
		<div id='露西' class='tab-pane fade'>
			<div class='row'>
				<h3>露西／루시</h3>
				<div class='col-xs-12 col-md-3 text-center'>
					<img src='http://i.imgbox.com/I8TxcTvH.jpg' class='trainer_img img-rounded'>
				</div>
				<div class='col-xs-12 col-md-5'>
					<div class="trainer_enable">
						<ul class='list-group'>
		...
		<div id='賽菈' class='tab-pane fade'>
			<div class='row'>
				<h3>賽菈／사라</h3>
				<div class='col-xs-12 col-md-3 text-center'>
					<img src='http://i.imgbox.com/wyU4Bouq.jpg' class='trainer_img img-rounded'>
				</div>
				<div class='col-xs-12 col-md-5'>
					<div class="trainer_enable">
						<ul class='list-group'>
		...
		<div id='卡比' class='tab-pane fade'>
			<div class='row'>
				<h3>卡比／가비</h3>
				<div class='col-xs-12 col-md-3 text-center'>
					<img src='http://i.imgbox.com/FylhwTJP.jpg' class='trainer_img img-rounded'>
				</div>
				<div class='col-xs-12 col-md-5'>
					<div class="trainer_enable">
						<ul class='list-group'>
		...
		<div id='波菲' class='tab-pane fade'>
			<div class='row'>
				<h3>波菲／포비</h3>
				<div class='col-xs-12 col-md-3 text-center'>
					<img src='http://i.imgbox.com/8XaFsado.jpg' class='trainer_img img-rounded'>
				</div>
				<div class='col-xs-12 col-md-5'>
					<div class="trainer_enable">
						<ul class='list-group'>
		...
		<div id='吉娜' class='tab-pane fade'>
			<div class='row'>
				<h3>吉娜／지나</h3>
				<div class='col-xs-12 col-md-3 text-center'>
					<img src='http://i.imgbox.com/0fOtZA8M.jpg' class='trainer_img img-rounded'>
				</div>
				<div class='col-xs-12 col-md-5'>
					<div class="trainer_enable">
						<ul class='list-group'>
		...
		<div id='烏巴' class='tab-pane fade'>
			<div class='row'>
				<h3>烏巴／우바</h3>
				<div class='col-xs-12 col-md-3 text-center'>
					<img src='http://i.imgbox.com/QLDMQomo.jpg' class='trainer_img img-rounded'>
				</div>
				<div class='col-xs-12 col-md-5'>
					<div class="trainer_enable">
						<ul class='list-group'>
				...
				<div class='col-xs-12 col-md-12'>
					<table class="trainer_skills">
						...
						<tbody>
							...
							<td>펫을 도와주자</td>
							<td>600</td>
							<td>在 3回合內為 1隻我方寵物分散承受其所受 49.5%傷害<br><strong>【當對象主屬性為地屬性】</strong> 額外提高防禦力 10%</td>
							</tr>
							...
							<td>널 지켜줄게</td>
							<td>被動</td>
							<td><strong>【回合開始時】</strong> 在 1回合內提高騎乘寵物防禦力 49.5%<br><strong>【當對象主屬性為地屬性】</strong> 防禦力提高 59.5%</td>
							</tr>
		...
		<div id='艾恩' class='tab-pane fade'>
			<div class='row'>
				<h3>艾恩／앤</h3>
				<div class='col-xs-12 col-md-3 text-center'>
					<img src='http://i.imgbox.com/6TRVhSHR.jpg' class='trainer_img img-rounded'>
				</div>
				<div class='col-xs-12 col-md-5'>
					<div class="trainer_enable">
						<ul class='list-group'>
				...
				<div class='col-xs-12 col-md-12'>
					<table class="trainer_skills">
						...
						<tbody>
							...
							<td>나만 믿어</td>
							<td>800</td>
							<td>在 2回合內提高對象防禦力 49.5%<br><strong>【額外效果】</strong> 在 2回合內免疫灼燒、暈眩</td>
							</tr>
